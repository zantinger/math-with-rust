...
#[wasm_bindgen]
impl Chart {
    pub fn power2(canvas_id: &str, power: i32) -> Result<Chart, JsValue> {
        let map_coord = func_custom_plot::draw(canvas_id, power).map_err(|err| err.to_string())?;
        Ok(Chart {
